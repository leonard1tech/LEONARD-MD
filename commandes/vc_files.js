...
zokou({ nomCom: 'channel',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`Support Here My Owner By Follow This Channel Please :hoo.be/leonardtech`) 
...
zokou({ nomCom: 'group1',
  ...
  async (dest, zk, commandeOptions) => {
    const { ms, arg, repondre } = commandeOptions;
                 ...
                 await repondre(`*Tap Here To Join ʟᴇᴏɴᴀʀᴅ ᴍᴅ Chatroom* hoo.be/leonardtech`) 
...
▬▬▬▬▬▬▬▬▬▬▬▬▬▬
❷ || WhattsApp Channel = hoo.be/leonardtech
▬▬▬▬▬▬▬▬▬▬▬▬▬▬
